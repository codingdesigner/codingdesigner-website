...
/**
* @file
* Contains functions to alter Drupal's markup for the tcd_2016 theme.
*
* The tcd_2016 theme borrows greatly from the Aurora theme.
 ...
 */
function tcd_2016_preprocess_node(&$vars) {
  ...
  $type_function = 'tcd_2016_preprocess_node__' . $vars['type'];
  if (function_exists($type_function)) {
    $type_function($vars);
  }

  // Provide node display preprocess functions.
  $display_function = 'tcd_2016_preprocess_node__' . $vars['view_mode'];
